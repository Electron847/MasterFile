...
public class ConvexHull2  //name of the java class file
{
    ...
    public static void main(String args[])
    {
        ...
        try {                               //try block for file import trying
            Scanner ls = new Scanner(file3);    //Scanner object variable
        ...
        ConvexHull2 myConvexHull = new ConvexHull2();     //ConvexHull object variable myConvexHull set equal to a new ConvexHull object not filled in
