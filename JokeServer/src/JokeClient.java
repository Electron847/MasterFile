...
class state extends JokeClient{
    String clientID_extension = this.clientID;

    boolean[] transmitJokeState = this.jokeModeState;
}
...
public class JokeClient {
    ...
    static boolean[] jokeModeState;          //boolean array class object variable 'jokeModeState' initialized
