...
/***
 * set of unit tests for the Inventory.java file
 */
...
public class InventoryTEST extends TestCase {
    ...
    /***
     *
     * tests checkIn() method
     * tests checkOut() method
     */
    ...
    public void testCheckOutCheckIn() {
        ...
        try { s.checkIn(v1);        fail(); } catch ( IllegalArgumentException e ) {}   //why is this not working?
