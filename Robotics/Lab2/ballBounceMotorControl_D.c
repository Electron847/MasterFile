...
int ellipse_width 		= 64;
int ellipse_height 		= 64;
...
//void getDistance()
//{
//	string motn= (switchm) ? ("leftMotor") : ("rightMotor");
//	long dis= (switchm) ? (getMotorEncoder(leftMotor)) : (getMotorEncoder(rightMotor));
//	displayTextLine(5, "%s: %d degrees", dis);
//	sleep(5000);
//	displayTextLine(5,"");
//  if(switchm){
