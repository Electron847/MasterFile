...
class PingPong extends Actor {
  ...
  def receive = {
    ...
    case markerSend(myNeighbors) =>
      ...
      //println(sender.equals(self.path.parent)
      ...
      /*  println("\nActor sending the markers = " + self.path.name)   //starts with first
        println("Left Neighbor = " + myNeighbor.ls.path.name)    //starts with second
        println("Right Neighbor = " + myNeighbor.rs.path.name)  //starts with third*/
        ...
        //map +=  (neighbor.rightSide -> mutable.Queue(Marker(Neighbors(self, neighbor.leftSide))))
        //markerFlagRightCounterClockwise = true
...
object Server extends App {
  ...
  //first ! markerSend(Spin(second, third))
